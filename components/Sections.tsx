  ...
  return (
    <section className="section py-20">
      <div className="grid items-center gap-10 lg:grid-cols-2">
        ...
        <div>
          <span className="chip">● Your Travel Partner</span>
          <h2 className="mt-4 font-display text-4xl font-extrabold leading-tight text-ink-900 sm:text-5xl">
            More than a booking site —<br />a dedicated travel desk.
          </h2>
          <p className="mt-5 text-slate-600">
            {SITE.name} pairs technology with real human expertise. Our specialists scan private
            inventory you won't see on public search engines, then negotiate every detail of your
            itinerary so you can step on board worry-free.
          </p>
          <div className="mt-8 grid gap-5 sm:grid-cols-3">
            {[
              { label: '10M+ Travellers' },
  ...
  return (
    <section className="section py-20">
      <div className="mb-10 text-center">
        <span className="chip">● Traveller Stories</span>
        <h2 className="mt-3 font-display text-4xl font-extrabold tracking-tight text-ink-900 sm:text-5xl">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {TESTIMONIALS.map((t) => (
          <figure key={t.name} className="card relative p-8">
            ...
            <blockquote className="mt-5 text-lg italic leading-relaxed text-slate-700">
              {t.quote}
            </blockquote>
            ...
            <div className="absolute right-6 top-6 opacity-20">
              <Icon name="plane" className="h-10 w-10 text-brand-500" />
            </div>
          </figure>
        ))}
      </div>
